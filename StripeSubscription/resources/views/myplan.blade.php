  ...
  <header class="text-center mb-5 text-white">
      <div class="row">
        <div class="col-lg-12 mx-auto">
          <h1> Cashier Stripe My Continue Subscription</h1>
          <h3>Enjoy!!!</h3>
        </div>
      </div>
    </header>
...
<canvas id="confetti"></canvas> --}}
    ...
    {{-- <canvas id="confetti"></canvas> --}}
    <div class="row text-center align-items-end" style="margin-left: 15%">

    @foreach($subscriptions as $plan)
        @if ($plan->id === 1)
            <div class="col-lg-4 mb-5 mb-lg-0" style="width: 80%; padding-bottom:100px">
                <div class="bg-white p-5 rounded-lg shadow">
                <h1 class="h6 text-uppercase font-weight-bold mb-4">{{ $plan->name }}</h1>
                <h4 style="margin-right: 60%">Subsciption Buy : {{ $date }}</h4><br>
                <h2 class="h1 font-weight-bold">₹{{ $plan->price }}<span class="text-small font-weight-normal ml-2">/ month</span></h2>

                <div class="custom-separator my-4 mx-auto bg-primary" style="width: 30%"></div>
                ...
                <h4 style="margin-right: 60%">Date Expired : {{ $expiredDate }}</h4><br>
                <a href="{{ route('plans.show',$plan->slug) }}" class="btn btn-primary btn-block shadow rounded-pill" style="width: 20%" >Recharge Advance</a>
                </div>
        </div>
        @elseif ($plan->id === 2)
        <div class="col-lg-4 mb-5 mb-lg-0" style="width: 80%; padding-bottom:100px">
        ...
        @elseif ($plan->id === 3)
        <div class="col-lg-4 mb-5 mb-lg-0" style="width: 80%; ">
            <div class="bg-white p-5 rounded-lg shadow">
            <h1 class="h6 text-uppercase font-weight-bold mb-4">{{ $plan->name }}</h1>
            <h4 style="margin-right: 60%">Subsciption Buy : {{ $date }}</h4><br>
            <h2 class="h1 font-weight-bold">₹{{ $plan->price }}<span class="text-small font-weight-normal ml-2">/ month</span></h2>
